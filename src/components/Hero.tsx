...
export const Hero: React.FC<HeroProps> = ({ onRegisterPortal }) => {
  ...
  return (
    <section className="relative min-h-[250vh] md:min-h-[300vh] flex flex-col items-center">
      ...
      <div 
        className="fixed inset-0 flex items-center justify-center text-center px-6 pointer-events-none z-20"
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center text-center px-6 overflow-hidden z-10">
        <div 
        ...
        <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-black to-transparent pointer-events-none opacity-40 temple-silhouette" />
      </div>
